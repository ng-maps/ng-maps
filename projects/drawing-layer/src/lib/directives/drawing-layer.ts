...
export class NgMapsDrawingLayer implements OnDestroy, OnChanges {
   ...
   */
  @Output() overlayComplete: EventEmitter<
   ...
   */
  @Output() circleComplete: EventEmitter<google.maps.Circle> = new EventEmitter<
    google.maps.Circle
  >();
   ...
   */
  @Output() markerComplete: EventEmitter<google.maps.Marker> = new EventEmitter<
    google.maps.Marker
  >();
   ...
   */
  @Output() polylineComplete: EventEmitter<
   ...
   */
  @Output() polygonComplete: EventEmitter<
    google.maps.Polygon
   ...
   */
  @Output() rectangleComplete: EventEmitter<
