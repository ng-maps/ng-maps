...
export class NgMapsDrawingLayer implements OnDestroy, OnChanges {
   ...
   */
  @Output() overlayComplete: EventEmitter<google.maps.drawing.OverlayCompleteEvent> = new EventEmitter<google.maps.drawing.OverlayCompleteEvent>();

  /**
   * This event emitter gets emitted when the user finishes drawing a circle.
   */
  @Output() circleComplete: EventEmitter<google.maps.Circle> = new EventEmitter<google.maps.Circle>();

  /**
   * This event emitter gets emitted when the user finishes drawing a marker.
   */
  @Output() markerComplete: EventEmitter<google.maps.Marker> = new EventEmitter<google.maps.Marker>();

  /**
   * This event emitter gets emitted when the user finishes drawing a polyline.
   */
  @Output() polylineComplete: EventEmitter<google.maps.Polyline> = new EventEmitter<google.maps.Polyline>();

  /**
   * This event emitter gets emitted when the user finishes drawing a polygon.
   */
  @Output() polygonComplete: EventEmitter<google.maps.Polygon> = new EventEmitter<google.maps.Polygon>();

  /**
   * This event emitter gets emitted when the user finishes drawing a rectangle.
   */
  @Output() rectangleComplete: EventEmitter<google.maps.Rectangle> = new EventEmitter<google.maps.Rectangle>();
  ...
  private _addEventListeners() {
    const overlayComplete =
      this._drawingManagerManager.createEventObservable<any>('overlaycomplete', this)
    ...
    const circleComplete =
      this._drawingManagerManager.createEventObservable<google.maps.Circle>('circlecomplete', this)
    ...
    const markerComplete =
      this._drawingManagerManager.createEventObservable<google.maps.Marker>('markercomplete', this)
    ...
    const polylineComplete =
      this._drawingManagerManager.createEventObservable<google.maps.Polyline>('polylinecomplete', this)
    ...
    const polygonComplete =
      this._drawingManagerManager.createEventObservable<google.maps.Polygon>('polygoncomplete', this)
    ...
    const rectangleComplete =
      this._drawingManagerManager.createEventObservable<google.maps.Rectangle>('rectanglecomplete', this)
