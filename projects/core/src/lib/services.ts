...
export { GoogleMapsScriptProtocol, LAZY_MAPS_API_CONFIG } from './services/maps-api-loader/lazy-maps-api-loader-config';
...
export { LazyMapsAPILoaderConfigLiteral } from './services/maps-api-loader/lazy-maps-api-loader-config';
